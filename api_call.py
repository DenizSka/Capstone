...
def avg_follower_num():
    ...
    with open ('api_tweet_data.json', 'r') as f:
        ...
        return round(sum(list_followers)/len(list_followers))
...
def hashtag_percentage():
    ...
    with open ('api_tweet_data.json', 'r') as f:
        ...
        return round(100*tweets_with_hashtag/tweet_count)
...
def mention_percentage():
    ...
    with open ('api_tweet_data.json', 'r') as f:
        ...
        return round(100*tweets_with_mentions/tweet_count)
...
def most_tweet_num_user():
    ...
    with open ('api_tweet_data.json', 'r') as f:
        ...
        return f" user:{user}, tweet_count: '{tweets_count}' "


# The average number of tweets from an individual user.
def avg_tweet_num_per_user():
    tweets_counts = []
    with open ('api_tweet_data.json', 'r') as f:
        for one in json.load (f):
        ...
        return round(sum(tweets_counts)/len(tweets_counts))
